...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/js/Component.vue?vue&type=template&id=54b545d1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"enter-active-class":_vm.transition.enter,"leave-active-class":_vm.transition.leave}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isActive),expression:"isActive"}],staticClass:"toast",class:[("toast-" + _vm.type), ("is-" + _vm.position)],attrs:{"role":"alert"},on:{"click":_vm.onClick}},[_c('p',{staticClass:"toast-text"},[_vm._v(_vm._s(_vm.message))])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/js/Component.vue?vue&type=template&id=54b545d1&
...
var api_Api = function Api(Vue) {
  ...
  return {
    open: function open(options) {
      ...
      var propsData = Object.assign({}, defaultOptions, globalOptions, options);
